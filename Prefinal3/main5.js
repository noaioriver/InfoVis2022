async function main(){
    ...
    geoChart.addListener('click', (e, d) => {
        ...
        /*ccolor[selected]=preselectedc;
        preselectedc=ccolor[d.properties.name_ja];
        ccolor[d.properties.name_ja]="gold";
        selected=d.properties.name_ja;*/////

        //ここから
        /*if(geoChart.ccolor["北海道"]==""){
            preselectedc="white";
            thisdata.forEach((d, i) => {
                // d.color = d3.interpolateRdBu(i / dtw_selected.length);
        ...
        /*geoChart.chart.selectAll("path")
            ...
            .style('fill', d => {
                if (d.properties.name_ja==selected) {
                    return "gold"
                } 
                else {
                    if(Object.keys(geoChart.ccolor).length!=1){
                        return ccolor[d.properties.name_ja]
                    }
                    else{
                        return "white"
                    }
