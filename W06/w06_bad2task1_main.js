d3.csv("https://noaioriver.github.io/InfoVis2022/W04/w04_task1.csv")
    .then( data => {
...
class ScatterPlot {
    ...
    update() {
        ...
        self.rexscale.domain( [xmin, xmax] );

        const ymin = d3.min( self.data, d => d.y );
        const ymax = d3.max( self.data, d => d.y );
        self.reyscale.domain( [ymin, ymax] );
    ...
    render() {
        ...
        self.chart.selectAll("circle")
            ...
            .enter()
            .append("circle")
            .attr("cx", d => self.rexscale( d.x ) )
            .attr("cy", d => self.reyscale( d.y ) )
            .attr("r", d => d.r )
