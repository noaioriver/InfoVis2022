...
class BarChart {
    ...
    render() {
        ...
        let mydata=self.value

        switch(this.data_type){
            case "total":
                mydata=self.value
            case "10s":
                mydata=self.fiveyears+self.tenyears
        }
        ...
        self.chart.selectAll("rect")
            ...
            .attr("width", d => self.xscale(mydata))
            .attr("height", self.yscale.bandwidth())
            .style("fill",
            function(d){
                if(d.value==d3.max( self.data, d => mydata ))
                {return "red";}
                else if(d.value==d3.min( self.data, d => mydata ))
                {return "blue";}
            })
        ...
        self.chart.selectAll("totalnumber")
            ...
            .text(d=>mydata)
            .attr("text-anchor", "middle")
            .attr("x",  d => self.xscale(mydata)-15)
